      ...
      <q-page-sticky v-if="$q.screen.gt.sm" expand position="left">
        <div class="fit q-pt-xl q-px-sm column">
          <q-btn
            ...
            size="26px"
            class="GPL__side-btn"
            @click="loadHouseHolderCSV()"
          >
            <q-icon size="22px" name="photo" />
            <div class="GPL__side-btn__label">加载村民数据</div>
          </q-btn>
          <q-btn
            round
            flat
          ...
          >
            ...
            <div class="GPL__side-btn__label">加载乡村信息</div>
            <q-badge
              floating
              color="red"
              text-color="white"
          ...
          >
            <router-link to="/aboutSoft">
              ...
              <div class="GPL__side-btn__label">关于软件</div>
            </router-link>
          </q-btn>
        </div>
      </q-page-sticky>
